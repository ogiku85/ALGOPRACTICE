...
namespace ALGOPRACTICE.Models
{
    ...
    {
        public Tuple<int[], int> SortArrayAndCountingInversion(int[] nums)
        {
           // int noOfConversions = 0;
            return MergeSort(nums);
        }
        public Tuple<int[], int> MergeSort(int[] nums)
        {
            int[] sortedResultArray = null;
            int count = 0;
            //this is the count of how many elements are out of order i.e number of swap
            try
            {
                ...
                // add helper function with merge sort
                int[] MergeSortHelper(int[] nums, int leftIndex, int rightIndex)
                {
                    int[] result = null;
                    try
                    {
                        ...
                        //add helper function with mergesort helper
            ...
            return new Tuple<int[], int>(sortedResultArray, count);
        }
